...
repeat 5 ./gpurecsplit_construction  --numObjects 5M --numQueries 50M --leafMethod bruteforce  --leafSize 16 --bucketSize 2000 --numThreads 1
...
repeat 5 ./simdrecsplit_construction --numObjects 5M --numQueries 50M --leafMethod rotations  --leafSize 18 --bucketSize 50 --numThreads 128
...
repeat 5 ./gpurecsplit_construction  --numObjects 5M --numQueries 50M --leafMethod bruteforce  --leafSize 18 --bucketSize 50 --numThreads 1
...
repeat 1 ./gpurecsplit_construction  --numObjects 5M --numQueries 50M --leafMethod bruteforce  --leafSize 24 --bucketSize 2000 --numThreads 1
