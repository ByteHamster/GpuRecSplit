...
inline int clzll(uint64_t word) {
#ifdef _MSC_VER
	unsigned long result;
 ...
 *
 */
inline int lambda(uint64_t word) { return 63 ^ clzll(word); }
 ...
 *
 */
inline int lambda_safe(uint64_t word) { return word == 0 ? -1 : 63 ^ clzll(word); }
 ...
 *
 */
inline uint64_t mask_lambda(uint64_t word) { return 0x8000000000000000ULL >> clzll(word); }
